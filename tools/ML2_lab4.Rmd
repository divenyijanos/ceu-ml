...
simulateRun("ETC", VERSION_PROBS, sim_length = 200, policy_params = list(explore_until = 100))
```
...
etc80_results <- runSimulations(n_sim, "ETC", VERSION_PROBS, policy_params = list(explore_until = 80))
...
model_results <- bind_rows(
    ...
    mutate(etc30_results, policy = "ETC10"),
